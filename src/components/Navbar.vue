<template>
  <div
    class="bg-whitesmoke [backdrop-filter:blur(20px)] w-full overflow-hidden flex flex-col items-center justify-center p-6 box-border text-left text-base text-gray-200 font-inter"
  >
    <div class="w-full flex flex-row items-center justify-center">
      <div class="w-[1200px] flex flex-row items-center justify-between">
        ...
        >
          ...
          >
            <div class="relative leading-[150%]">Album ảnh</div>
          </div>
          <div
            class="flex flex-row items-center justify-center py-3 px-0 cursor-pointer"
            :onClick="openBoxGift"
          >
            <div class="relative leading-[150%]">Mừng cưới</div>
          </div>
        </div>
      </div>
    </div>
